...
- #### Стили (/styles)
  ...
  - UploadPage.css - стили страницы загрузки **(Этап 4)**
...
### 2. Фронтенд
- Страница загрузки: выбор файла, три шага обработки, автозапуск цепочки, все состояния (загрузка, ошибка, успех), кнопки управления
...
- Адаптив страницы загрузки (Алина)
