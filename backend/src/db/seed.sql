...
(1, 4, 'in_review', 'Договор на поставку - на рассмотрении в отделе закупок'),
(1, 5, 'pending_verification', 'Юридическая проверка договора'),
(2, 4, 'verified', 'Письмо согласовано, ответ отправлен'),
(3, 2, 'in_review', 'Техническая неисправность - проверка техотделом'),
(4, 5, 'in_review', 'Уведомление о проверке - юристам'),
(5, 3, 'verified', 'Счёт оплачен'),
(6, 4, 'verified', 'Акт подписан, оборудование принято'),
(7, 5, 'in_review', 'Соглашение на юридической проверке'),
(8, 3, 'verified', 'Счёт-фактура проведена'),
(9, 5, 'in_review', 'Предписание - требуется ответ'),
(9, 2, 'pending_verification', 'Техническая часть предписания'),
(10, 5, 'verified', 'Договор аренды согласован'),
(11, 4, 'in_review', 'Письмо о гарантии - в работе'),
(12, 6, 'in_review', 'Кадровый вопрос - отдел кадров'),
(13, 3, 'pending_verification', 'Уведомление о ценах - бухгалтерия'),
(14, 3, 'verified', 'Счёт оплачен'),
(15, 3, 'verified', 'Акт сверки подписан');
