      ...
      <div className="profile-menu-container" ref={menuRef}>
        ...
        {showProfileMenu && (
          <div className="profile-dropdown-menu">
            ...
            >
              <img src="/icons/header/User.png" className="Casual-icon" alt="👤" />
            ...
            >
              <img src="/icons/sidebar/Settings.png" className="Casual-icon" alt="⚙️" />
              <span>Настройки</span>
            </button>
            ...
            >
              <img src="/icons/sidebar/Exit.png" className="Casual-icon" alt="🚪" />
              <span>Выйти</span>
            </button>
          </div>
        )}
